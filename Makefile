build:
	docker buildx build --platform linux/arm64  -f ./Dockerfile . -t sensecraft-missionpack.seeed.cn/suzhou/websocket-meshtastic-bridge:v0.7
push:
...
tag:
	docker tag sensecraft-missionpack.seeed.cn/suzhou/websocket-meshtastic-bridge:v0.7 sensecraft-missionpack.seeed.cn/suzhou/websocket-meshtastic-bridge:latest
