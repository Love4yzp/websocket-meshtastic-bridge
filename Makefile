...
tag:
	docker tag sensecraft-missionpack.seeed.cn/suzhou/websocket-meshtastic-bridge:v0.2 sensecraft-missionpack.seeed.cn/suzhou/websocket-meshtastic-bridge:latest
